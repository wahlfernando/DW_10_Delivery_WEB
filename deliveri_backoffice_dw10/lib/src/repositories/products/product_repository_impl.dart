...
class ProductRepositoryImpl implements ProductRepository {
  ...
  Future<void> save(ProductModel productModel) async {
    try {
      ...
      log('Erro salvar produto', error: e, stackTrace: s);
  ...
  Future<String> uploadImageProduct(Uint8List file, String filename) async {
    try {
      ...
      log('Erro ao fazer pload do arquivo', error: e, stackTrace: s);
      throw RepositoryException(message: 'Erro ao fazer pload do arquivo');
    }
  }
}
